...
pub fn perror_fmt(message: impl AsRef<str>) -> impl Fn(nix::errno::Errno) -> String {
...
#[derive(Debug)]
pub struct EthernetComms {
    sockfd: std::os::fd::OwnedFd,
    peer_address: LinkAddr,
}

impl EthernetComms {
    pub fn new(ethertype: u16, ifname: &str, peer_mac: [u8; 6]) -> Result<Self, String> {
        let sockfd = socket(
    ...
    pub fn send_frame(&self, frame: &[u8]) -> nix::Result<usize> {
